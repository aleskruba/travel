...
function LoginDialog() {
  ...
  return (
    <div>
        ...
        <div className="relative bg-white p-2 rounded-lg flex items-center justify-center flex-col w-[350px] min-w-[350px] h-full max-h-[450px] md:w-[450px] md:h-[550px]">
     ...
     <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
      <Form className="flex flex-col space-y-4 items-center w-[350px] ">
        ...
        <div className="flex space-x-4">
          ...
          <img className='flex mt-4 h-auto  min-h-[80px] w-full' src="lide.svg" alt="lide" />
        </div>
