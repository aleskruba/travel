...
function YourTourDetail() {
  ...
  return (
    ...
    <div className=' flex flex-col items-center'>
        ...
        <div className='pt-4'>
        <img src="/man.png"alt={yourTour?.firstName} className='rounded-full h-24 w-24 mx-auto' />
            </div>
            <div>
        <h3 className='flex flex-col items-center text-xl font-semibold'> {yourTour?.firstName}</h3>  
        </div> 
